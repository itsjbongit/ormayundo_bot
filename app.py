...
# Configuration and Handlers Imports
from config.settings import BOT_TOKEN
from bot.handlers.start import start, handle_onboarding
from bot.handlers.menu import handle_menu, handle_callback, set_state
from bot.keyboards.main_menu import main_menu
from services.scheduler import check_reminders, db
from keep_alive import keep_alive

# ==========================================
# 1. DEFINE YOUR HANDLER FUNCTIONS GLOBALLY
# ==========================================
...
async def debug_sticker(update: Update, context: ContextTypes.DEFAULT_TYPE):
...
# ==========================================
# 2. DEFINE THE MAIN RUN FUNCTION
# ==========================================
...
def main():
    ...
    # Securely schedule our continuous reminder loop sequence
    ...
    # Start polling for updates safely
    print("🤖 Ormayundo Bot is listening in POLLING mode...")
    application.run_polling(close_loop=False)


# ==========================================
# 3. START THE BOT UP ON ENVIRONMENT LAUNCH
# ==========================================
